...
WebUI.callTestCase(findTestCase('Navigation and fill in/Fill in Field on Loyalty/Register Page/Nomor HP - Less than 10 character'), 
    [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Verify UI Text and Image/Loyalty/Register page/Alert phone number less than 10'), [:], 
    FailureHandling.STOP_ON_FAILURE)
