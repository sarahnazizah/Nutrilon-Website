...
WebUI.callTestCase(findTestCase('Navigation and fill in/Fill in Field on Loyalty/Register Page/Nomor HP - Letter Character'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Verify UI Text and Image/Loyalty/Register page/Verify Letter - Field Phone Number'), [:], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Verify UI Text and Image/Loyalty/Register page/Alert Nomor Mama Wajib Diisi'), [:], FailureHandling.STOP_ON_FAILURE)
