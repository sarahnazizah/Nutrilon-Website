...
WebUI.callTestCase(findTestCase('NavFill/Fill/Register Page/Nomor HP - Letter Character'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('UI Verif/Loyalty/Register page/Verify Letter - Field Phone Number'), [:], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('UI Verif/Loyalty/Register page/Alert Nomor Mama Wajib Diisi'), [:], FailureHandling.STOP_ON_FAILURE)
