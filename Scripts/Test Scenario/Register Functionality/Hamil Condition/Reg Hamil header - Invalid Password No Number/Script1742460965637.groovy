...
WebUI.callTestCase(findTestCase('NavFill/Fill/Register Page/Password - huruf kecil dan simbol'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('UI Verif/Loyalty/Register page/Alert Password Tidak Sesuai - No Number'), 
    [:], FailureHandling.STOP_ON_FAILURE)
