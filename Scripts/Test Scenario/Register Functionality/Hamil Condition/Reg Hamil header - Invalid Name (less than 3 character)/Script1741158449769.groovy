...
WebUI.callTestCase(findTestCase('NavFill/Fill/Register Page/Nama Mama - less than 3 character'), 
    [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('UI Verif/Loyalty/Register page/Alert nama mama Minimal 3 character'), [:], FailureHandling.STOP_ON_FAILURE)
