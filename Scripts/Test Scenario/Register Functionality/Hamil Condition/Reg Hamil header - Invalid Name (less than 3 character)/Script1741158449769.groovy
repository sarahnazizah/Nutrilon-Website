...
WebUI.callTestCase(findTestCase('Navigation and fill in/Fill in Field on Loyalty/Register Page/Nama Mama - less than 3 character'), 
    [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Verify UI Text and Image/Loyalty/Register page/Alert nama mama Minimal 3 character'), [:], FailureHandling.STOP_ON_FAILURE)
