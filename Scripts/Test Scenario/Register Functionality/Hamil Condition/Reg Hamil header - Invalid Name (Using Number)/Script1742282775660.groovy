...
WebUI.callTestCase(findTestCase('Navigation and fill in/Fill in Field on Loyalty/Register Page/Nama Mama - Number'), [:], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Verify UI Text and Image/Loyalty/Register page/Verify Numeric - Field Nama Mama'), [:], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Verify UI Text and Image/Loyalty/OTP page/UI and Text on Login OTP page'), [:], FailureHandling.STOP_ON_FAILURE)
