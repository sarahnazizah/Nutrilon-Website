...
WebUI.callTestCase(findTestCase('Navigation and fill in/Fill in Field on Loyalty/Register Page/Fill in registered phone number'), 
    [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Verify UI Text and Image/Loyalty/Register page/Alert Nomor Mama sudah Terdaftar'), [:], FailureHandling.STOP_ON_FAILURE)
