...
WebUI.callTestCase(findTestCase('NavFill/Fill/Register Page/Fill in registered phone number'), 
    [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('UI Verif/Loyalty/Register page/Alert Nomor Mama sudah Terdaftar'), [:], FailureHandling.STOP_ON_FAILURE)
