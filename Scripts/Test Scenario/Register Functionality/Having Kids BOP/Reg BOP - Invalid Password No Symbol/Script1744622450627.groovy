...
WebUI.callTestCase(findTestCase('NavFill/Fill/Register Page/Password - huruf kecil dan angka'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('UI Verif/Loyalty/Register page/Alert Password Tidak Sesuai - No Symbol'), 
    [:], FailureHandling.STOP_ON_FAILURE)
