...
WebUI.callTestCase(findTestCase('Navigation and fill in/Fill in Field on Loyalty/Register Page/Password - huruf kecil dan angka'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Verify UI Text and Image/Loyalty/Register page/Alert Password Tidak Sesuai - No Symbol'), 
    [:], FailureHandling.STOP_ON_FAILURE)
