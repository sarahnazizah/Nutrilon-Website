...
WebUI.callTestCase(findTestCase('NavFill/Fill/Login OTP page/Fill in invalid phone (less than 10)'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('UI Verif/Loyalty/Login OTP page/Alert Field Less Than 10 character'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('NavFill/Tap hyperlink/Login OTP/Tap button Masuk'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('UI Verif/Loyalty/Login OTP page/Alert Box Minimal 10 Karakter'), [:], FailureHandling.STOP_ON_FAILURE)
