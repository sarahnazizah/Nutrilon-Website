...
WebUI.callTestCase(findTestCase('Navigation and fill in/Fill in Field on Loyalty/Login OTP page/Fill in invalid phone (less than 10)'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Verify UI Text and Image/Loyalty/Login OTP page/Alert Field Less Than 10 character'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Verify UI Text and Image/Loyalty/Login OTP page/Alert Box Minimal 10 Karakter'), [:], FailureHandling.STOP_ON_FAILURE)
